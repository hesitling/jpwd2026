...
- [ ] 3.5 修改 PasswordTable 的双击事件，显示 PasswordDetailDialog

## 4. 实现删除密码功能

- [ ] 4.1 修改 deleteSelectedPassword() 方法，获取选中的密码条目
- [ ] 4.2 实现确认对话框，显示将要删除的密码条目数量
- [ ] 4.3 调用 VaultService 删除密码条目
- [ ] 4.4 删除后刷新密码列表
