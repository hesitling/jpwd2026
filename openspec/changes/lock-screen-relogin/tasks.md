...
- [x] 1.2 在 setupContentPanel() 中创建 LockPanel 实例并添加到 CardLayout
- [x] 1.3 添加 showLockPanel() 方法

## 2. 保存锁定前的用户名

- [x] 2.1 添加 lockedUsername 字段到 MainFrame
- [x] 2.2 修改 lockApplication() 保存当前用户名
...
- [x] 4.4 在构造函数中注册 SessionListener

## 5. 测试和验证

- [x] 5.1 测试手动锁定后显示 LockPanel
- [x] 5.2 测试会话超时后显示 LockPanel
- [x] 5.3 测试密码正确解锁成功
- [x] 5.4 测试密码错误显示错误信息
